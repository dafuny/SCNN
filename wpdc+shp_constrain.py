...
from sia_loss import WPDCLoss, WPDCLoss_re,WPDCLoss_0, WPDCLoss_1, WPDCLoss_4
...
log_file = "./training_debug/logs/wpdc+shp_constrain_0/"
#loss
snapshot = "./training_debug/logs/wpdc+shp_constrain_0/"
log_mode = 'w'
resume = ''
size_average = True
num_classes = 62
...
def train(train_loader, model, criterion_wpdc, criterion_shp, optimizer_wpdc, optimizer_shp, epoch):
    #status:training!
    model.train()
...
#    optimizer = torch.optim.Adam(model.parameters(),lr = base_lr)
    ...
    for epoch in range(start_epoch, epochs+1):
        ...
        #train for one epoch
        train(train_loader, model, criterion_wpdc, criterion_shp, optimizer_wpdc, optimizer_shp, epoch)
        #save model paramers
